...
make_plots(df_ch, "att_sch_pub", c("diff_cc", "need_cc_bi"), show = TRUE, title = "diff_cc and need_cc_bi")#added show=TRUE
make_plots(df_ch, "att_sch_chart", c("diff_cc", "need_cc_bi"), show = TRUE, title = "diff_cc and need_cc_bi") #added
make_plots(df_ch, "att_sch_mag", c("diff_cc", "need_cc_bi"), show = TRUE, title = "diff_cc and need_cc_bi") #added
```
...
```{r}
make_plots(df_ch, "inc_dist", "lr_cc_gov", show = TRUE, title = "lr_cc_gov") #added show=TRUE
```
...
lapply(c(demographics, concerns), function(item) {
  make_plots(df_ch, item, "att_prsn_bi", title = item)
})
```
...
make_plots(df_ch, "att_con_trans", "inc_be_med_before", show = "yes", title = "inc_be_med_before")
```
