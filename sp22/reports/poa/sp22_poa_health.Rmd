...
make_plots(wrangled, by_vars = demographics,
         hyp_var = c("posi_all", "posi_yes"), title = "Households and Individuals with a case of COVID")
...
make_plots(wrangled, demographics, "boost_bi", "Respondents who have received a booster vaccine dose")
```
...
```{r}
make_plots(wrangled, c("rate_gov_all_good", "rate_gov_all_bad"), "boost_bi",
